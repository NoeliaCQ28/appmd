...
export const AlternatorBadget = ({ alternatorId, onRemove }) => {
  const { alternator, isLoadingAlternator, isErrorAlternator } =
    useAlternators(alternatorId);

  if (isLoadingAlternator) {
    return <div>Cargando...</div>;
  }

  if (isErrorAlternator) {
    return <div>Error al cargar el alternador</div>;
  }
