...
export const AddCablesModal = ({ visible, onClose }) => {
  return (
    ...
    <div className='fixed inset-0 bg-black/60 z-10 w-screen overflow-y-auto'>
      <div className='flex min-h-full items-center justify-center'>
        <DialogPanel
          transition
          className="w-full max-w-4xl m-10 transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all p-6"
        >
          <div>
